...
urlpatterns = [
    ...
    # asset can login asset-user
    path('assets/<uuid:pk>/asset-users/',
         api.AssetAssetUserApi.as_view(), name='asset-asset-user'),
    path('assets/<uuid:pk>/asset-users/<str:username>/auth-info/',
         api.AssetAssetUserAuthInfoApi.as_view(), name='asset-asset-user-auth-info'),

    path('admin-user/<uuid:pk>/nodes/',
         api.ReplaceNodesAdminUserApi.as_view(), name='replace-nodes-admin-user'),
    # admin-user asset auth-info
    path('admin-user/<uuid:pk>/assets/<uuid:aid>/auth-info/',
         api.AdminUserAssetAuthInfoApi.as_view(), name='admin-user-asset-auth-info'),
    ...
    path('credentials/', api.CredentialsApi.as_view(), name='credentials'),
    path('credentials/<uuid:pk>/auth-info/',
         api.CredentialsAuthInfoApi.as_view(), name='credentials-auth-info'),
